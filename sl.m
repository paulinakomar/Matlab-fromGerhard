function [twotheta1, Intensity1, twotheta2, Intensity2, IntensityGauss1, IntensityGauss2] = sl()
...
%% Parameters needed for the simulation of satellite peaks of 200 and 400 peaks
    ...
    f_a200 = 143.75;
    f_a400 = 250.87;
        d_a=5.941/4; % lattice constant / 4 = real lattice spacing of atomic layers in real space
    ...
    % two theta range
    twotheta1=25:0.01:33; % in degrees
    twotheta2=56:0.01:66; % in degrees
